...
const callerNumber = '+441751242035';
...
function makeCall(request, response) {
  ...
  if (!to) {
      ...
      //Added in call recording feature here
      const dial = voiceResponse.dial({record: 'record-from-ringing-dual', callerId : callerNumber});
      dial.number(to);
  } else {
